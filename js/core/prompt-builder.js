...
- [item_add:物品名|描述|类型|数量] 给予玩家物品`);
    ...
    buildStateUpdateSchemaHint() {
        return `{ "strategies": { "create": [...], "update": [...] }, "knowledgeAdd": [], "discoveryUpdate": [], "intelAdd": [], "factionsUpdate": [], "characterUpdates": [{ "characterName": "NPC名", "trustDelta": 0, "suspicionDelta": 0 }], "clockUpdate": [], "storyArcUpdate": [], "storyPhaseUpdate": [], "clueUpdate": [], "failureStateUpdate": [], "counterStrategyUpdate": [], "npcAgendaUpdate": [], "challengeUpdate": [], "evidenceAdd": [], "revelationUpdate": [], "flowGraphUpdate": {}, "questsUpdate": [], "itemAdd": [], "locationUpdate": [], "scene": { "worldTensionDelta": 0, "activeStrategyId": "" } }`;
    },
